...
function(e) {
    ...
    return t.prototype = {
        ...
        _buildShape: function() {
            ...
            h = {},
            V = 0,
            d = e.length; d > V; V++) if (e[V].type == m.CHART_TYPE_MAP && (e[V] = this.reformOption(e[V]), i = e[V].mapType, s[i] = s[i] || {},
            s[i][V] = !0, l[i] = l[i] || e[V].mapValuePrecision, this._scaleLimitMap[i] = this._scaleLimitMap[i] || {},
            e[V].scaleLimit && U.merge(this._scaleLimitMap[i], e[V].scaleLimit, !0), this._roamMap[i] = e[V].roam || this._roamMap[i], (null == this._hoverLinkMap[i] || this._hoverLinkMap[i]) && (this._hoverLinkMap[i] = e[V].dataRangeHoverLink), this._nameMap[i] = this._nameMap[i] || {},
            e[V].nameMap && U.merge(this._nameMap[i], e[V].nameMap, !0), this._activeMapType[i] = !0, e[V].textFixed && U.merge(u, e[V].textFixed, !0), e[V].geoCoord && U.merge(y, e[V].geoCoord, !0), this._selectedMode[i] = this._selectedMode[i] || e[V].selectedMode, (null == this._hoverable[i] || this._hoverable[i]) && (this._hoverable[i] = e[V].hoverable), (null == this._clickable[i] || this._clickable[i]) && (this._clickable[i] = e[V].clickable), (null == this._showLegendSymbol[i] || this._showLegendSymbol[i]) && (this._showLegendSymbol[i] = e[V].showLegendSymbol), h[i] = h[i] || e[V].mapValueCalculation, t = e[V].name, this.selectedMap[t] = o ? o.isSelected(t) : !0, this.selectedMap[t])) {
                r[i] = r[i] || {},
                n = e[V].data;
                for (var p = 0,
                g = n.length; g > p; p++) {
                    a = this._nameChange(i, n[p].name),
                    r[i][a] = r[i][a] || {
                        seriesIndex: [],
                        valueMap: {}
                    };
        ...
        _getProjectionData: function(e, t, i) {
            ...
            n.left != l.left || n.top != l.top || n.scale.x != l.scale.x || n.scale.y != l.scale.y ? (s = a.geoJson2Path(t, n, this._specialArea[e]), l = U.clone(n)) : (n = this._mapDataMap[e].transform, s = this._mapDataMap[e].pathArray),
        ...
        __onmouseup: function(e) {
            ...
            setTimeout(function() {
                ...
                i._justMove = !1,
                i.zr.un(d.EVENT.MOUSEMOVE, i._onmousemove),
                i.zr.un(d.EVENT.MOUSEUP, i._onmouseup)
            },
            120)
        },
        ...
        __ondrhoverlink: function(e) {
            ...
            this._hoverLinkMap[t] && this._activeMapType[t] && (i = V.get(this.shapeList[n], "value"), null != i && i >= e.valueMin && i <= e.valueMax && this.zr.addHoverShape(this.shapeList[n]))
        },
        onclick: function(e) {
