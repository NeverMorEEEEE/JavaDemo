 ...
 <%@page import="com.app.tools.DateUtil"%>
<!-- /demo/print_ywd.jsp -->
<html>
<title></title>
<%@include file="/include/head.jsp"%>
<script type="text/javascript" src="${WEB_APP}/lodop/LodopFuncs.js"></script>
<script src="${WEB_APP}/js/jquery.min.js" type="text/javascript"></script>
<%
